...
<Link href="/" className="flex items-center gap-3 absolute left-1/2 -translate-x-1/2">
  ...
  <div className="flex flex-col items-start leading-tight">
    <span className="font-display text-lg md:text-xl font-bold text-brand-green tracking-wider">
      Subhiksham
    </span>
    <span className="font-display text-[10px] md:text-xs text-brand-ochre tracking-[0.2em] uppercase -mt-0.5">
      The Tiffin Club
    </span>
    <span className="flex items-center gap-1 mt-0.5">
      <span className="veg-dot" />
      <span className="text-[9px] text-brand-green font-medium tracking-wider">PURE VEG</span>
    </span>
  </div>
</Link>
...
function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/918594001666?text=Hi%20Subhiksham!%20I%27d%20like%20to%20know%20more."
      target="_blank"
