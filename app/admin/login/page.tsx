    ...
    <div className="min-h-screen bg-[#FDF6E3] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#2D4A3E]/50 text-sm mt-1 italic">Admin Panel</p>
        </div>
        ...
        <p className="text-center text-xs text-[#2D4A3E]/40 mt-5">
          First time?{' '}
          <a href="/admin/setup" className="underline hover:text-[#2D4A3E]/70">
            Go to setup
          </a>
        </p>
      </div>
